...
class UserConfig {
   ...
   </ label="Enable game information", help="Show game information", options="Yes,No", order=12 /> enable_ginfo="No";
   </ label="Enable text frame", help="Show text frame", options="Yes,No", order=13 /> enable_frame="No"; 
